...
public class App {
    public static void greet() {
        System.out.println("HELLO THIS IS HIMANSHU BISHT");
    }


    public static void line() {
        System.out.println("---------------------------------------------");
        System.out.println("Welcomes you to the flight reservation app");
    }
    ...
    public static void page1() {
        ...
        System.out.println("6. Update Your Tourist Ticket Address");
    ...
    public static void main(String[] args) {
        ...
        Flight flight = new Flight(3030, "Size Jet", "Lucknow to Yew York");
        ...
        for (int i = 0; i <= 0;) {
            ...
            // show page 1 option
            line();
            // method will print page1 options
            page1();
            line();
